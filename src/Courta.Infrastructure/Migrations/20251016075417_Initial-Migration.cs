...
namespace Courta.Infrastructure.Migrations
{
    /// <inheritdoc />
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Permissions",
                columns: ["Id", "CreatedAt", "CreatedBy", "Description", "IsDeleted", "Name", "UpdatedAt", "UpdatedBy"],
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: ["Id", "CreatedAt", "CreatedBy", "Email", "FirstName", "IsActive", "IsDeleted", "IsVerified", "LastName", "PasswordHash", "SecurityStamp", "UpdatedAt", "UpdatedBy", "Username"],
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: [new Guid("22222222-2222-7222-8222-222222222222"), new Guid("11111111-1111-7111-8111-111111111111")]);
